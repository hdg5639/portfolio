...
(() => {
  ...
  const detailContent = {
    likes: {
      icon: '💚',
      title: '좋아하는 것들',
      html: '<p>피아노를 치면서 머리를 식히거나, FPS·RPG 게임에 오래 몰입하는 것을 좋아합니다.<br>자동차나 전자기기를 살 계획이 없어도 스펙과 실사용 후기를 비교해보는 것 자체를 즐깁니다.</p>'
    },
    dislikes: {
      icon: '🙅',
      title: '잘 맞지 않는 것들',
      html: '<p>이유를 설명할 수 없는 반복 작업, 말의 앞뒤가 맞지 않는 상황, 책임질 준비 없이 일을 먼저 벌이는 태도를 답답하게 느낍니다.<br>다만 무조건 싫어하기보다 왜 그런 방식이 되었는지부터 확인하려고 합니다.</p>'
    },
    routine: {
      icon: '🏠',
      title: '평소 생활 방식',
      html: '<p>SSAFY 일정을 제외하면 집에서 보내는 시간이 많습니다.<br>게임이나 피아노로 쉬고, 너무 오래 집에만 있어 답답할 때는 목적지를 정하지 않고 드라이브를 나갑니다.<br>소비할 때는 먼저 성능을 확인한 뒤 가격과 사용 기간을 비교합니다.</p>'
    }
  };
